...
class Transaksi extends CI_Controller
{
  ...
  function add_keluar()
  {
    ...
    $data['barang'] = $this->MTransaksi->get_master_toobject("vbarang", "pk_barang_id", "kocak", "nama_barang", "Select", "", "");
    $data['petugas'] = $this->MTransaksi->getPetugas();
...
>>>>>>> db99e93597fb24f5947d36e5b01ed4ad3aa344a5
    );
...
function delete($pk_transaksi_keluar_id)
{

  //proses
  $this->MTransaksi->hapus_data($pk_transaksi_keluar_id);
  redirect('transaksi-keluar-view');
  //output
  // $this->session->set_flashdata('message', '<div class="alert alert-warning alert-dismissible" role="alert">
  //       <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
