...
class Petugas extends CI_Controller
{
  ...
  function index()
  {
    ...
    $this->load->view('master/petugas/vpetugas', $data);
  ...
  function update_view($id)
  {
    ...
    $petugas = $this->MPetugas->getpetugasbyid($id);
    $data['petugas'] = $petugas[0];

    $this->load->view('templates/head/tabel');
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/petugas/veditpetugas', $data);
    $this->load->view('templates/footer/tabel');
  }
  ...
  function add_view()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/petugas/vaddpetugas');
    $this->load->view('templates/footer/tabel');
  }
